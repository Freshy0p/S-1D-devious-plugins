...
public class FletchShaft extends FletcherTask {
    public FletchShaft(S1dFletcherPlugin context) {
        super(context);
    }

    @Override
    public boolean validate() {
        return this.isCurrentActivity(Activity.IDLE) && this.hasMaterial() && this.isMode(Mode.FLETCHING_SHAFTS) && this.hasKnife();
    }

    @Override
    public int execute() {
        this.setActivity(Activity.FLETCHING_SHAFTS);
