...
public class FletchShield extends FletcherTask {
    public FletchShield(S1dFletcherPlugin context) {
        super(context);
    }

    @Override
    public boolean validate() {
        return this.isCurrentActivity(Activity.IDLE) && this.hasMaterial() && this.isMode(Mode.FLETCHING_SHIELD) && this.hasKnife();
    }

    @Override
    public int execute() {
        this.setActivity(Activity.FLETCHING_SHIELD);
